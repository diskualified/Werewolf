...
import hu.ait.werewolf.data.activeUser
...
fun LoginScreen(onLoginSuccess: () -> Unit, loginViewModel: LoginViewModel = viewModel()) {
    ...
    var email by rememberSaveable { mutableStateOf("johnnyappleseed@ait.hu") }
            ...
            Row(
                ...
                OutlinedButton(onClick = {
                    coroutineScope.launch(Dispatchers.IO) {
                        val res = loginViewModel.loginUser(email, password)
                        if (res?.user != null) {
